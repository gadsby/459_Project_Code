...
for i = 1:var_array_length
    ...
    Y_lb(i,7) = -4.8; % Lower bound - input knee joint
    Y_ub(i,7) = 4.8; % Upper bound - input knee joint
    
    Y_lb(i,8) = -4.8; % Lower bound - input hip joint
    Y_ub(i,8) = 4.8; % Upper bound - input hip joint
end
