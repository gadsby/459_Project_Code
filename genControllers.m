...
C_2x2 = zeros(2,2,L);
for k = 1:L1
A = [ 0 0 0 0 0 0 ; -a22(i)*kt*kv/R -a22(i)*kt*kv/R -a22(i)*kt*kv/R 0 0 0 ...
    ; 0 0 0 -a23(i)*kt*kv/R -a23(i)*kt*kv/R -a23(i)*kt*kv/R ; 0 0 0 0 0 0 ...
    ; -a32(i)*kt*kv/R -a32(i)*kt*kv/R -a32(i)*kt* kv/R 0 0 0 ; ...
    0 0 0 -a33(i)*kt*kv/R -a33(i)*kt*kv/R -a33(i)*kt*kv/R];

B = [0 0 -a21(i) 0 0; a22(i)*kt/R 0 0 -a22(i) 0 ; 0 a23(i)*kt/R 0 0 -a23(i) ...
    ; 0 0 -a31(i) 0 0 ; a32(i)*kt/R 0 0 -a32(i) 0 ; 0 a33(i)*kt/R 0 0 -a33(i)];
...
for i = 1:2
    for j = 1:3
        [symNum,symDen] = numden(T_2x3(i,j,k)); %get num and den of Symbolic TF
